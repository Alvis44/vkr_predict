...
BASE_USER = os.environ.get('BASE_USER')
...
#SECRET_KEY = 'django-insecure-=09!w#3dylt57vd0+#0^etu^thq5q1e5q3#_u1@*xmxj1zqn(1'
...
ALLOWED_HOSTS = ['task-list-alvis.herokuapp.com', 'localhost']
